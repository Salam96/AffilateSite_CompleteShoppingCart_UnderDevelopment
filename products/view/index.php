...
Include_once('../controller/anonymous_home_page.php'); 
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <li class="nav-item">
        <a class="nav-link" <?php echo  "href=../view/material-login-form/index.html"?>>Client area</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" <?php echo  "#"?>>About</a>
      </li>
    </ul>
  </div>
